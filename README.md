...
Application for tracking income and expenses. It uses Next.js with [NeonDB](https://fyi.neon.tech/traversy) to persist data and [Clerk](https://go.clerk.com/BsG2XQJ) for authentication.
